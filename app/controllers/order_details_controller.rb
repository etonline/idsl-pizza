  ...
  def create
    ...
    respond_to do |format|
      if @order_detail.save
        format.html { redirect_to [@order, @order_detail], notice: 'Order detail was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @order_detail.update(order_detail_params)
        format.html { redirect_to [@order, @order_detail], notice: 'Order detail was successfully updated.' }
